...
def nuevo_producto():
    ...
    respuesta = requests.post(url='http://localhost:3000/productos/registrar', data=data)#post porque envia datos !!!!!!!!!!!!!
...
def nueva_venta():
    ...
    seguir=False
    while not seguir:
        id = input('Ingrese el id del producto. Presione 0 para salir : ')
        if (id == '0'):
            seguir=True
        else:
